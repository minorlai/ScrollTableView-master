 ...
 */
public class FourStartsAdapter extends BaseAdapter {
    private ArrayList<PriceOrderBean> priceList;
    private Context context;
    // 用来控制CheckBox的选中状况
    private static HashMap<Integer, Boolean> isSelected;
    public final static int type = 4;//标识是这个adapter

    public FourStartsAdapter(ArrayList<PriceOrderBean> priceList, Context context) {
    ...
    public static void setIsSelected(HashMap<Integer, Boolean> isSelected) {
        FourStartsAdapter.isSelected = isSelected;
    }
}
