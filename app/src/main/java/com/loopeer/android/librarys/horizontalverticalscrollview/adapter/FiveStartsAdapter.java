 ...
 */
public class FiveStartsAdapter extends BaseAdapter {
    private ArrayList<PriceOrderBean> priceList;
    private Context context;
    // 用来控制CheckBox的选中状况
    private static HashMap<Integer, Boolean> isSelected;
    public final static int type = 5;//标识是这个adapter

    public FiveStartsAdapter(ArrayList<PriceOrderBean> priceList, Context context) {
    ...
    public static void setIsSelected(HashMap<Integer, Boolean> isSelected) {
        FiveStartsAdapter.isSelected = isSelected;
    }
}
