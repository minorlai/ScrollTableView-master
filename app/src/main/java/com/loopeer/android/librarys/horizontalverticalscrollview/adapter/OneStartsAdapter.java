 ...
 */
public class OneStartsAdapter extends BaseAdapter {
    private ArrayList<PriceOrderBean> priceList;
    private Context context;
    // 用来控制CheckBox的选中状况
    private static HashMap<Integer, Boolean> isSelected;
    public final static int type = 1;//标识是这个adapter

    public OneStartsAdapter(ArrayList<PriceOrderBean> priceList, Context context) {
    ...
    public static void setIsSelected(HashMap<Integer, Boolean> isSelected) {
        OneStartsAdapter.isSelected = isSelected;
    }
}
