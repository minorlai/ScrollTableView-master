 ...
 */
public class TwoStartsAdapter extends BaseAdapter {
    private ArrayList<PriceOrderBean> priceList;
    private Context context;
    // 用来控制CheckBox的选中状况
    private static HashMap<Integer, Boolean> isSelected;
    public final static int type = 2;//标识是这个adapter

    public TwoStartsAdapter(ArrayList<PriceOrderBean> priceList, Context context) {
    ...
    public static void setIsSelected(HashMap<Integer, Boolean> isSelected) {
        TwoStartsAdapter.isSelected = isSelected;
    }
}
